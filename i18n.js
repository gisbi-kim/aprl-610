...
translations.push(['메뉴 접기','Hide menu'],['메뉴','Menu'],['전체화면 닫기','Exit full screen'],['전체화면','Full screen'],['Space 점프 · 공중에서 한 번 더 누르면 2단 점프','Space to jump · Press again in midair to double jump'],['점프 · 2단 점프','Jump / Double jump'],['GS 탭은 입구 시점으로 시작합니다.','The GS tab starts from the entrance.'],['자동 둘러보기 재생','Play auto tour'],['자동 둘러보기 정지','Stop auto tour'],['자동 둘러보기','Auto tour']);
...
function render() {
 ...
 for (const root of document.querySelectorAll('aside,footer,#loading,#toast,#sceneFullscreen,#menuToggle')) {
